...
* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/MDAnalysis/mdgeomkit/issues)
...
The second two options both involve making a [pull request](https://github.com/MDAnalysis/mdgeomkit/pulls) .
